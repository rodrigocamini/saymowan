...
namespace MantisBase2Saycao.PageObjects
{
    public class CriarTarefaPageObjects : DriverFactory
    {
        ...
        {
            uteis.clicaBotao(MenuCriarTarefa, uteis.RetornaNomeVariavel(() => MenuCriarTarefa));
        }

        public void selecionarCategoria(string valor)
        {
            uteis.escolherElementoDropDown(DropDownCategoria, valor, uteis.RetornaNomeVariavel(() => DropDownCategoria));
        }

        public void selecionarCategoriaAleatoria()
        {
            uteis.escolherValorAleatorioNaLista(DropDownCategoria, uteis.RetornaNomeVariavel(() => DropDownCategoria));
        }
        ...
        {
            uteis.preencheCampoInput(TextoDescricao, valor, uteis.RetornaNomeVariavel(() => TextoResumo));
        }
