...
namespace MantisBase2Saycao.PageObjects
{
    public class LoginPageObjects
    {
        ...
        {
            uteis.preencheCampoInput(InputSenha, senha, uteis.RetornaNomeVariavel(() => InputSenha));
        }
        ...
        {
            DriverFactory.INSTANCE.Navigate().GoToUrl(ConfigurationManager.AppSettings["urlBase"].ToString());
        }
