...
namespace MantisBase2Saycao.PageObjects
{
    public class VerTarefasPageObjects : DriverFactory
    {
        ...
        {
            uteis.clicaBotao(TextoAtribuir, uteis.RetornaNomeVariavel(() => TextoAtribuir));
        }

        public void selecionarAtribuido(string valor)
        {
            uteis.escolherElementoDropDown(DropDownAtribuir, valor, uteis.RetornaNomeVariavel(() => DropDownAtribuir));
        }
        ...
        public void preencherNovoFiltro(string valor)
        { uteis.preencheCampoInput(TextoNovoFiltro, valor, uteis.RetornaNomeVariavel(() => TextoNovoFiltro)); }
